            ...
            >
              <div className="xb-item--content">
                ...
                <ul className="xb-item--holder ul_li list-unstyled">
                  <li>
                    <Image src="/images/icon/location-icon02.svg" alt="location" width={500} height={500} /> {job.location}
                  </li>
                  <li>
                    <Image src="/images/icon/clock-icon.svg" alt="clock" width={500} height={500} /> {job.type}
                  </li>
                </ul>
              </div>
