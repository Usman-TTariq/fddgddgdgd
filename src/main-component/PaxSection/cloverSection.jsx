...
import GallerySection from "../PaxSection/GallerySection";
    ...
    return (
        <section className="service-details pos-rel">
            <div className="container">
                {/* ========= SERVICE IMAGE + VIDEO ========= */}
                <div className="single-item-image service-det-img">
                    {/* <Image src="/images/service/img13.jpg" alt="simage" width={500} height={500} /> */}
                ...
                Upgrade to Dynamic PAX POS
                Systems for Prompt Payments
                </h2>

                <p>
                    It's time to adopt a better, faster, and more efficient way of selling with the help of the latest PAX point of sale systems. PAX offers one of the most diverse POS system catalogues with the world's best-selling A920Pro and advanced SmartECR devices. These POS terminals are built to fulfil the needs of modern-day fast-paced businesses of any scale, from small businesses to globally operating franchises.
                </p>
