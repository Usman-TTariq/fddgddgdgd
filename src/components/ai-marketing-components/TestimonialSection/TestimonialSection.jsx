                                    ...
                                    <div className="xb-item--inner">
                                        <div className="xb-item--content">
                                            <div className="xb-item--quote">
                                                <Image src="/images/icon/quote-icon.png" alt="icon" width={500} height={500} />
                                            </div>
                                            ...
                                            <div className="xb-item--holder">
                                                ...
                                                <div className="xb-item--brand">
                                                    <Image src="/images/testimonial/brand.png" alt="logo" width={500} height={500} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="xb-item--inner">
                                        <div className="xb-item--content">
                                            ...
                                            <div className="xb-item--holder">
                                                ...
                                                <div className="xb-item--brand">
                                                    <Image src="/images/testimonial/brand02.png" alt="logo" width={500} height={500} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="xb-item--inner">
                                        <div className="xb-item--content">
                                            ...
                                            <div className="xb-item--holder">
                                                ...
                                                <div className="xb-item--brand">
                                                    <Image src="/images/testimonial/brand03.png" alt="logo" width={500} height={500} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="xb-item--inner">
                                        <div className="xb-item--content">
                                            ...
                                            <div className="xb-item--holder">
                                                ...
                                                <div className="xb-item--brand">
                                                    <Image src="/images/testimonial/brand04.png" alt="logo" width={500} height={500} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
