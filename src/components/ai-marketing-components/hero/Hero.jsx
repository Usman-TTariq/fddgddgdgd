        ...
        <div className="container-fluid">
          <div className="hero-content hero-content--three">
            ...
            >
              <h2 className="title">
                AI Marketing{" "}
                <Image src="/images/icon/b10c3e43e836d32554bf.gif" alt="animated gif" width={500} height={500} /> for Smarter Insights and
              </h2>
              ...
              <span className="hero-shape">
                <Image src="/images/icon/animated-gif02.gif" alt="animated gif" width={500} height={500} />
              </span>
            </div>
            ...
            >
              <div className="xb-item--holder ul_li">
                ...
                <div className="xb-item--audience ul_li">
                  <Image src="/images/hero/audience-img01.png" alt="Audience 1" width={500} height={500} />
                  <Image src="/images/hero/audience-img02.png" alt="Audience 2" width={500} height={500} />
                  <Image src="/images/hero/audience-img03.png" alt="Audience 3" width={500} height={500} />
                </div>
              </div>
