        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            <div className="hero-img-container">
              ...
              >
                <Image src="/images/hero/hero-img01.png" alt="AI Chatbot" width={500} height={500} />
              </div>

              <div className="xb-text-left wow updown">
                <div className="img img--1">
                  <Image src="/images/hero/text-img01.png" alt="text-img1" width={500} height={500} />
                </div>
                <div className="img img--2">
                  <Image src="/images/hero/text-img02.png" alt="text-img2" width={500} height={500} />
                </div>
              </div>

              <div className="xb-glassy-effect-img wow">
                <Image src="/images/hero/glassy-effect-img.png" alt="Glassy Effect" width={500} height={500} />
              </div>

              <div className="xb-text-right wow updown">
                <div className="img img--1">
                  <Image src="/images/hero/text-img03.png" alt="text-img3" width={500} height={500} />
                </div>
                <div className="img img--2">
                  <Image src="/images/hero/text-img04.png" alt="text-img4" width={500} height={500} />
                </div>
                <div className="img img--3">
                  <Image src="/images/hero/text-img05.png" alt="text-img5" width={500} height={500} />
                </div>
              </div>
            </div>
          </div>
