    ...
    >
      <div className="container">
        <div className="sec-title sec-title--two tes-sec-title text-center mb-50">
          ...
          >
            <Image src="/images/icon/sub_left-_white_icon.png" alt="icon" width={500} height={500} /> Testimonials{" "}
            <Image src="/images/icon/sub_right-_white_icon.png" alt="icon" width={500} height={500} />
          </span>
          <h2
            ...
            data-wow-duration="600ms"
          >
            Hear from our <Image src="/images/icon/animated-gif03.gif" alt="shape" width={500} height={500} /> happy customers
          </h2>
        </div>
      </div>
      ...
      <div className="testimonial-wrapper">
        ...
        >
          ...
          <SwiperSlide>
            <div className="ac-testimonial-item ul_li xb-border">
              <div className="xb-item--avatar">
                <Image src="/images/avatar/author_01.png" alt="Priya Ramirez" width={500} height={500} />
              </div>
              ...
              <div className="xb-item--quote">
                <Image src="/images/testimonial/quote.png" alt="quote" width={500} height={500} />
              </div>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="ac-testimonial-item ul_li xb-border">
              <div className="xb-item--avatar">
                <Image src="/images/avatar/author_02.png" alt="Sebastian Clark" width={500} height={500} />
              </div>
              <div className="xb-item--holder">
                <p className="xb-item--content">
          ...
          <SwiperSlide>
            <div className="ac-testimonial-item ul_li xb-border">
              <div className="xb-item--avatar">
                <Image src="/images/avatar/author_03.png" alt="Miguel Torres" width={500} height={500} />
              </div>
              <div className="xb-item--holder">
                <p className="xb-item--content">
