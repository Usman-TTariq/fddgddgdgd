        ...
        <div className="container">
          <div className="sec-title sec-title--two custom-sec-title feature-sec-title text-center mb-45">
            <span className="sub-title">
              <Image src="/images/icon/sub-left-icon.png" alt="icon" width={500} height={500} /> Aivora AI Chatbot Features
            </span>
            <h2 className="title">
              <span>
                <Image src="/images/icon/artificial-intelligence-11761.gif" alt="AI Animation" width={500} height={500} />
              </span>
          ...
          <div className="row mt-none-30">
              ...
              <div className="xb-feature-item-3 big-item">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <Image src="/images/feature/feature-img03.png" alt="Automate feature" width={500} height={500} />
                    <span className="logo">
                      <Image src="/images/feature/logo.png" alt="logo" width={500} height={500} />
                    </span>
                  </div>
            ...
            <div className="col-lg-4 col-md-6 mt-30 order-lg-first">
              <div className="xb-feature-item-3">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <Image src="/images/feature/feature-img02.png" alt="Sync Data" width={500} height={500} />
                    <span className="scan-img updown-2">
                      <Image src="/images/feature/scan.png" alt="scan" width={500} height={500} />
                    </span>
                  </div>
                  <div className="xb-item--holder">
            ...
            <div className="col-lg-4 col-md-6 mt-30">
              <div className="xb-feature-item-3">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <Image src="/images/feature/feature-img04.png" alt="Multilingual" width={500} height={500} />
                    <span className="circle">
                      <Image src="/images/feature/circle.png" alt="circle" width={500} height={500} />
                    </span>
                  </div>
                  <div className="xb-item--holder">
            ...
            <div className="col-lg-4 col-md-6 mt-30">
              <div className="xb-feature-item-3">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <Image src="/images/feature/feature-img05.png" alt="Advanced Reporting" width={500} height={500} />
                  </div>
                  <div className="xb-item--holder">
            ...
            <div className="col-lg-4 col-md-6 mt-30">
              <div className="xb-feature-item-3">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <Image src="/images/feature/feature-img06.png" alt="Security" width={500} height={500} />
                    <span className="security">
                      <Image src="/images/feature/security.png" alt="security" width={500} height={500} />
                    </span>
