      ...
      <div className="container">
        ...
        <div className="sec-title sec-title--two pricing-sec-title text-center mb-30">
          <span className="sub-title wow fadeInUp" data-wow-duration="600ms">
            <Image src="/images/icon/sub-left-icon.png" alt="icon" width={500} height={500} /> Pricing Plans{" "}
            <Image src="/images/icon/sub-right-icon.png" alt="icon" width={500} height={500} />
          </span>
          <h2
          ...
          >
            Simple & <Image src="/images/icon/money-icegif-22-unscreen.gif" alt="shape" width={500} height={500} /> flexible pricing
          </h2>
        </div>
        ...
        <div className="row mt-none-30">
          ...
          <div className="col-lg-5 mt-30">
            ...
            >
              <div className="xb-icon">
                <Image src="/images/icon/pricing-icon01.svg" alt="icon" width={500} height={500} />
              </div>
          ...
          <div className="col-lg-7 mt-30">
            ...
            >
              <div className="xb-icon">
                <Image src="/images/icon/pricing-icon02.svg" alt="icon" width={500} height={500} />
              </div>
