        ...
        <div className="sidebar_widget">
          ...
          <ul className="recent_post_block list-unstyled">
            ...
            <li className="recent_post_item xb-border">
              ...
              <span>
                <Image src="/images/icon/profile-circle.svg" alt="author" width={500} height={500} /> By Michael David
              </span>
            </li>
            ...
            <li className="recent_post_item xb-border">
              ...
              <span>
                <Image src="/images/icon/profile-circle.svg" alt="author" width={500} height={500} /> By Christopher
              </span>
            </li>
            ...
            <li className="recent_post_item xb-border">
              ...
              <span>
                <Image src="/images/icon/profile-circle.svg" alt="author" width={500} height={500} /> By William Thomas
              </span>
            </li>
