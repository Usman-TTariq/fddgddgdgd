    ...
    <section className="blog_details_section pt-70">
      <div className="container">
        ...
        <div className="single-item-image mb-70">
          <Image src="/images/blog/img08.jpg" alt="Blog" width={500} height={500} />
        </div>
            ...
            <div className="blog_details_content">
              ...
              <div className="row mb-35 mt-none-30">
                <div className="col-md-6 col-sm-6 mt-30">
                  <div className="single-item-image">
                    <Image src="/images/blog/img09.jpg" alt="Blog" width={500} height={500} />
                  </div>
                </div>
                <div className="col-md-6 col-sm-6 mt-30">
                  <div className="single-item-image">
                    <Image src="/images/blog/img10.jpg" alt="Blog" width={500} height={500} />
                  </div>
                </div>
              </div>
              ...
              <div className="row mb-45 align-items-center mt-none-30">
                <div className="col-md-6 mt-30">
                  <Image src="/images/blog/img11.jpg" alt="Blog" className="single-item-image"  width={500} height={500} />
                </div>
              ...
              <div className="post-block-wrap mb-50">
                <div className="postabmin_block xb-border ul_li">
                  ...
                  <div className="admin_image">
                    <Image src="/images/avatar/author-img.png" alt="Author" width={500} height={500} />
                  </div>
